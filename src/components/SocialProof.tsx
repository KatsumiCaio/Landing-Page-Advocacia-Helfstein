...
import { Star, MessageCircle, Quote, ArrowRight } from 'lucide-react';
  ...
  return (
    <section id="depoimentos" className="relative py-16 lg:py-24 bg-[#050a14] border-b border-[#c5a059]/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Section Header */}
        <div className="mb-14 text-center sm:text-left flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
          ...
          <div className="border border-[#c5a059] bg-[#02050a] p-4 flex items-center gap-4 shrink-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t) => (
            <div
              key={t.id}
              className="p-6 border border-[#c5a059]/20 bg-[#080d17] hover:border-[#c5a059] transition-all flex flex-col justify-between space-y-6"
            >
              ...
              <div className="pt-4 border-t border-[#c5a059]/20 flex items-center justify-between">
                <div>
                  <h4 className="text-xs font-serif font-bold text-[#c5a059]">
                    {t.author}
                  </h4>
                  <p className="text-[10px] text-gray-400">
                    {t.roleOrContext || 'Cliente Verificado'}
                  </p>
                </div>
                <span className="text-[9px] uppercase tracking-wider text-[#c5a059] border border-[#c5a059]/30 px-2 py-0.5 bg-[#02050a]">
                  Verificado
                </span>
              </div>
            </div>
        ...
        {/* Sleek CTA Banner */}
        <div className="mt-14 p-8 border-2 border-[#c5a059] bg-[#02050a] flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-center md:text-left">
            <h3 className="text-lg sm:text-xl font-serif text-[#c5a059]">
          ...
          <a
            ...
            className="shrink-0 px-8 py-4 bg-[#c5a059] hover:bg-[#e6be6a] text-black font-bold text-xs uppercase tracking-widest transition-all flex items-center gap-3 shadow-[0_4px_20px_rgba(197,160,89,0.25)]"
          >
